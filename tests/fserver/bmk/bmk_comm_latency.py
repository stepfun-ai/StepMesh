...
def print_thread():
    ...
    while True:
        start, end, costs, end1, end2 = print_queue.get()
        time_list.append((start, end, end1, end2))
        ...
        if len(time_list) == 10000:
            ...
            for i in range(len(time_list)):
                start, end, end1, end2 = time_list[i]
                start *= 1e3
                end *= 1e3
                end1 *= 1e3
                end2 *= 1e3
...
if is_worker:
    ...
    def worker():
        ...
        print_queue.put((start, end, costs, end1, end2))
